...
return [
    ...
    'permission'    =>  [
        'wrong-delete'  =>  'Для удаления объекта необходимы установленные права <b>:permit</b> Для получения прав обратитесь к администратору',
        'wrong'  =>  'Для данного действия необходимы установленные права <b>:permit</b> Для получения прав обратитесь к администратору',
        'deny'  =>  'Попытка несанкционированного доступа',
    ],
	'ckeditor' => [
		'upload'        => [
